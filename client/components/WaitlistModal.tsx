        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <motion.div
              ...
              className="inline-block align-bottom bg-white rounded-2xl text-left overflow-hidden shadow-2xl transform sm:my-8 sm:align-middle sm:max-w-lg sm:w-full relative z-10"
            >
              {!isSubmitted ? (
                <>
                  {/* Header */}
                ...
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-gray-600 mb-6">
                      ...
                      email from our customer success manager who will assist
                      you with getting started and answer any questions you may
                      have.
                    </p>
                    <p className="text-xs text-gray-500 mb-6">
                      We're excited to help transform your learning experience
                      with StudyBud's AI-powered insights.
                    </p>
                    <button
                      onClick={resetModal}
